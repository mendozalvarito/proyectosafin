...
(/** @lends <global> */function( $ ) {
	 ...
	 * parameters can have multiple form, and backwards compatibility.
	 *
	 * @param {object} oSettings dataTables settings object
	 ...
	 * take several different form for ease of use.
	 *
	...
	DataTable.defaults.column = {
		 ...
		 *    // (which has both form) is used for filtering for if a user inputs either format, while
